            ...
            <ul className="flex space-x-10">
              ...
              <li>
                <button className="" onClick={() => toggleVisibility("link1")}>
                  ...
                  {isVisible === "link1" && (
                    ...
                    >
                      <span className="hover:text-emerald-700 hover:font-semibold" onClick={() =>navigate('/grammar-checker')}>jHdlrk mÍlaIlh</span>
                      <span className="hover:text-emerald-700 hover:font-semibold" onClick={() =>navigate('/similar-words')}>iudk mo fiùu</span>
                    </div>
                  )}
              </li>
              ...
              <li>
                <button className="" onClick={() => toggleVisibility("link4")}>
                  <span className="font-semibold border-emerald-700  hover:border-b-3 p-1" onClick={() =>navigate('/feedback')}>woyia yd fhdackd</span>
                </button>
              </li>
