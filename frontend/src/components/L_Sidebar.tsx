...
const L_Sidebar:React.FC = () => {
    ...
    return (
        <div className="fixed flex flex-col items-center  text-center w-25 z-40 left-1 gap-3">
            ...
            <button className='flex flex-col w-22 h-22 border-3 items-center justify-center rounded-lg p-1 cursor-pointer font-CCWelikala border-[#0d8065] hover:bg-[#0d8065] hover:text-white hover:scale-110  transition duration-400'onClick={() => navigate('/similar-words')}>
            ...
            <button className='flex flex-col w-22 h-22 border-3 items-center justify-center rounded-lg p-1 cursor-pointer font-CCWelikala border-[#0d8065] hover:bg-[#0d8065] hover:text-white hover:scale-110  transition duration-400'onClick={() => navigate('/words-set')}>
                <img className='flex max-w-full h-9 mt-2  ' src={Paraphrase_img} alt="Paraphrase_picture"/>
