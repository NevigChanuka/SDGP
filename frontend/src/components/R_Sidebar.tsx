...
const R_Sidebar:React.FC = () => {
    ...
    return (
        <div className="fixed flex flex-col w-25 items-center text-center top-110 right-1 z-40">
            <button className='flex flex-col w-22 h-22 border-3 rounded-lg m-2 p-3 items-center justify-center cursor-pointer font-CCWelikala border-[#0d8065] hover:bg-[#0d8065] hover:text-white hover:scale-110  transition duration-400' >
