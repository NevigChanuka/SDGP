...
import logo from "../assets/VyakaranaLogo.png"; 
    ...
    <div className="w-[30%] h-[640px] mx-auto mt-12 bg-white p-10 rounded-2xl shadow-2xl border border-green-900">
      ...
      <form onSubmit={handleSubmit} className="mt-4">
        <div className="flex flex-col space-y-6">
          ...
          <button type="submit" className="mt-1 w-24 py-2 bg-green-900 text-white rounded-md hover:bg-green-900 mx-auto">
            Sign In
          </button>
        ...
        <div className="flex flex-col items-center justify-center w-full mt-1">
          ...
          <p className="text-center text-sm">
            New User?
            <a href="/SignUp" className= "text-green-900 hover:underline ml-1">
              Create an account
            </a>
          </p>
        </div>
